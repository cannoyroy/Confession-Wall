...
export default {
  ...
  methods: {
    logout() {
      ...
      console.log('logout')
      console.log('Token:', localStorage.getItem('token'), 'Expires?at:', localStorage.getItem('expiresAt'), 'now:', Date.now());
      window.location.href = "http://localhost:5173/"; // 跳转到登录页面
    }
  }
};
</script>
    ...
    <ul class="navbar-items flexbox-col">
        ...
        <li class="navbar-item flexbox-left">
            <a class="navbar-item-inner flexbox-left">
                ...
                <RouterLink :to="{ name: 'loginreg'}" class="link-text" @click.native="logout" >
                <span class="link-text">注销</span>
                </RouterLink>
            </a>
        </li>
        <!-- <li class="navbar-item flexbox-left">
