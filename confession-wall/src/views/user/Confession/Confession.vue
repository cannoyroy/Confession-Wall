    ...
    <div v-if="showEditModal" class="modal">
      <div class="modal-content">
        ...
        <form @submit.prevent="submitEdit">
          ...
          <textarea id="postContent" v-model="editFormData.postContent" required></textarea>
    ...
    <div v-if="showNewModal" class="modal">
      <div class="modal-content">
        ...
        <form @submit.prevent="New">
          ...
          <label for="postContent">帖子内容:</label>
          <textarea id="postContent" v-model="newFormData.postContent" placeholder="不得超过250字" @input="limitCharacters" required></textarea>
