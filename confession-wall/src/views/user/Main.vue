...
// const totalPosts = ref(0); // 总帖子数量，通常从后端获取
...
<!-- <div class="pagination">
    <button :disabled="currentPage.value === 1" @click="currentPage.value--">上一页</button>
    <span>第 {{ currentPage.value }} 页，共 {{ totalPages.value }} 页</span>
    <button :disabled="currentPage.value === totalPages.value" @click="currentPage.value++">下一页</button>
  </div> -->
