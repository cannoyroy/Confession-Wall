...
<template>
     <section class="accordion">
       <div class="item">
        ...
        <p>
            <el-input v-model="contact.phone" placeholder="电话（选填）"></el-input>
            <el-input v-model="contact.qq" placeholder="QQ（选填）"></el-input>
            <el-input v-model="contact.wechat" placeholder="微信（选填）"></el-input>
            <el-input v-model="contact.other" placeholder="其他联系方式（选填）"></el-input>
        </p>
        <div class="item">
            ...
            <p>
                ...
                ></el-cascader> -->
                <el-input v-model="selectedRegion" placeholder="输入地区（必填）"></el-input>
            </p>
        <div class="item">
            ...
            <p>
                <el-input v-model="avatarUrl" placeholder="头像链接（必填）"></el-input>
            </p>
        <div class="item">
